...
namespace SvgDemoWinForms
{
    public partial class MainForm : Form
    {
        ...
        public JsonViewForm JsonView { get; } = new();
        public SvgViewForm SvgView { get; } = new();
        public TreeViewForm TreeView { get; } = new();
        public LogViewForm LogView { get; } = new();
        ...
        public MainForm()
        {
            ...
            Utils.PreventFormDisposal(JsonView);
            Utils.PreventFormDisposal(SvgView);
            Utils.PreventFormDisposal(TreeView);
            Utils.PreventFormDisposal(LogView);
        ...
        {
            SelectionController.UpdateSelection(Model.Elements);
        }
